...
class WorkerCapitalistEconomyClass():
    # define constructor which is automatically called everytime an object is created
    def __init__(self):
...
# --- Next we define functions ---    
    ...
    def capitalists(self):
        ...
        # a. solve
        obj = lambda l: -self.utility_c((w*l+pi)/p,l) # substitute in the budget constraint
        res = optimize.minimize_scalar(obj,bounds=(0,1),method='bounded')
    ...
    def evaluate_equilibrium(self):
        ...
        self.workers() # prepend with self. when referencing method within class
        self.capitalists()
